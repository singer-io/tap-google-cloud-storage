...
class GCSAllFieldsTest(GCSBaseTest):

    table_entry = [{'table_name': 'all_fields_csv', 'search_prefix': 'tap_gcs_tester', 'search_pattern': 'CSV_file_with_duplicate_header.csv', 'key_properties': ['head1']}]
