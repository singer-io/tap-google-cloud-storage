...
class GCSCompressedZipFileJSONLCSV(GCSBaseTest):

    table_entry = [{'table_name': 'zip_has_jsonl_with_csv', 'search_prefix': 'tap_gcs_tester/zip_files', 'search_pattern': 'tap_gcs_tester/zip_files/.*\\.zip', 'key_properties': []}]
