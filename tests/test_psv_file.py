...
class GCSPsvFile(GCSBaseTest):
    """Test PSV file reading with pipe delimiter"""

    table_entry = [{'table_name': 'psv_data', 'search_prefix': 'tap_gcs_tester/psv', 'search_pattern': 'tap_gcs_tester/psv/.*\\.psv', 'key_properties': [], 'delimiter': '|'}]
    ...
    def resource_names(self):
        return ["sample_data.psv"]

    def name(self):
        return "test_psv_file"
