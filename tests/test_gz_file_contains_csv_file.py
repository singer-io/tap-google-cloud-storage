...
class GCSCompressedGZFileCSV(GCSBaseTest):

    table_entry = [{'table_name': 'gz_has_csv_data', 'search_prefix': 'tap_gcs_tester/gz_csv', 'search_pattern': 'tap_gcs_tester/gz_csv/.*\\.gz', 'key_properties': []}]
