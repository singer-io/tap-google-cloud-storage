...
class GCSAvroFile(GCSBaseTest):
    """Test Avro file reading"""

    table_entry = [{'table_name': 'avro_data', 'search_prefix': 'tap_gcs_tester/avro', 'search_pattern': 'tap_gcs_tester/avro/.*\\.avro', 'key_properties': []}]
