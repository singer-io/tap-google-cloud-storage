...
class GCSAutomaticFieldsTest(GCSBaseTest):
    ...
    def test_CSV_with_1_PK(self):
        ...
        self.headers = "id"
        self.table_entry = [{"table_name": "csv_with_pk", "search_prefix": "tap_gcs_tester", "search_pattern": "{}".format(self.file_name), "key_properties": ["{}".format(self.headers)]}]
        self.run_test()
    ...
    def test_CSV_with_2_PK(self):
        ...
        self.table_entry = [{"table_name": "csv_with_pk", "search_prefix": "tap_gcs_tester", "search_pattern": "{}".format(self.file_name), "key_properties": ["id", "name"]}]
        self.run_test()
