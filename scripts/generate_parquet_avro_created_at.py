...
def make_records():
    return [
        {"id": 701, "created_at": "2026-01-10T09:00:00Z", "name": "Ada", "active": True, "amount": 50.0},
        {"id": 702, "created_at": "2026-01-10T12:30:00Z", "name": "Bob", "active": False, "amount": 75.5},
        {"id": 703, "created_at": "2026-01-11T08:15:00Z", "name": "Chloe", "active": True, "amount": 200.25},
    ]
...
def main():
    out_parquet = Path("my_table_parquet_created_at.parquet")
    out_avro = Path("my_table_avro_created_at.avro")
    recs = make_records()
